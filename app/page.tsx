    ...
    <main className="min-h-screen bg-[#eef4fb] text-[#183b6b]">
      ...
      <nav className="fixed top-0 w-full z-50 bg-[#f8fbff]/90 backdrop-blur-md border-b border-[#dbe7f5]">
        <div className="max-w-7xl mx-auto px-5 py-4 flex justify-between items-center">
          ...
          <h1 className="text-xl md:text-2xl font-semibold text-[#183b6b] font-[family-name:var(--font-playfair)]">
            Luisa Chavez
          </h1>
          ...
          <div className="flex items-center gap-4 md:gap-8">
            ...
            <div className="hidden md:flex gap-8 text-[#355070] text-sm font-medium">
              <a href="#about" className="hover:text-[#183b6b] transition border-b-2 border-blue-500 pb-1">About</a>
              <a href="#research" className="hover:text-[#183b6b] transition">Research</a>
              <a href="#projects" className="hover:text-[#183b6b] transition">Projects</a>
              <a href="/Luisa_Chavez_CV.pdf" target="_blank" className="hover:text-[#183b6b] transition">CV</a>
            </div>

            {/* Icons: always visible */}
            <div className="flex items-center gap-4 text-[#355070]">
              <a href="https://github.com/Posheyla" target="_blank" className="hover:text-[#183b6b] transition">
              ...
              <a href="https://www.linkedin.com/in/luisa-ch%C3%A1vez-v%C3%A1squez/" target="_blank" className="hover:text-[#183b6b] transition">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      >
        ...
        <div className="max-w-5xl text-center relative z-10 pt-20">
          ...
          <p className="text-[0.75rem] md:text-[0.82rem] font-semibold uppercase tracking-[0.35em] md:tracking-[0.45em] text-[#445d8d] mb-6">
            Electrical Engineering · Robotics · Control
          </p>

          <h1 className="text-4xl sm:text-6xl md:text-8xl tracking-[-0.03em] font-[family-name:var(--font-playfair)] font-medium mb-6 text-[#162554]">
            Luisa Chavez Vasquez
          </h1>

          <p className="text-base md:text-2xl text-[#243b63] mb-8 leading-relaxed max-w-3xl mx-auto font-medium px-2">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 flex-wrap mb-10 px-8 sm:px-0">
            <a
              href="#projects"
              className="bg-[#5b7db1] hover:bg-[#4a6a99] text-white px-8 py-4 rounded-full font-medium transition shadow-md"
            >
              View Projects
            </a>
            <a
              ...
              target="_blank"
              className="border border-[#7d9cc3] text-[#243b63] px-8 py-4 rounded-full font-medium hover:bg-[#5b7db1] hover:text-white transition"
            >
              Download CV
            </a>
          </div>
          ...
          <div className="flex justify-center items-center gap-6 text-[#243b63] mt-2">
            <a href="https://github.com/Posheyla" target="_blank" className="flex items-center gap-2 hover:text-[#162554] transition">
            ...
            <a href="https://www.linkedin.com/in/luisa-ch%C3%A1vez-v%C3%A1squez/" target="_blank" className="flex items-center gap-2 hover:text-[#162554] transition">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/>
                <rect width="4" height="12" x="2" y="9"/>
                <circle cx="4" cy="4" r="2"/>
      ...
      <section id="about" className="px-6 py-24 bg-white">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          ...
          {/* Image + quote: stacked on mobile, side by side on md+ */}
          <div className="grid grid-cols-1 md:grid-cols-[1.35fr_1fr] gap-10 items-center">
            ...
            <div>
              ...
              <p className="italic text-[#355070] text-xl md:text-2xl leading-relaxed font-light">
      ...
      <section id="research" className="px-6 py-24 bg-[#eef4fb]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-[#8aa4c7] text-2xl mb-14">~~</div>

          {/* 3 columns on mobile (3x2 grid), 6 on desktop */}
          <div className="grid grid-cols-3 md:grid-cols-6 gap-y-10 gap-x-2 md:gap-0 items-start">
            {researchItems.map(({ icon, label1, label2 }, index) => (
              <div key={label1} className="relative flex flex-col items-center text-center px-2 md:px-4">
                <div className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-white border border-[#dbe7f5] shadow-sm flex items-center justify-center text-[#5b7db1] mb-3 md:mb-5">
                  {icon}
                </div>
                <p className="text-[#183b6b] font-semibold leading-snug text-xs md:text-sm">{label1}</p>
                <p className="text-[#355070] text-xs md:text-sm leading-snug">{label2}</p>
                {index !== 5 && (
          ...
          <div className="mt-12 h-px bg-[#dbe7f5]" />
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-[#f7fbff] border border-[#dbe7f5] rounded-3xl overflow-hidden shadow-sm hover:shadow-2xl hover:-translate-y-2 transition duration-300">
              <video autoPlay loop muted playsInline className="w-full h-56 md:h-64 object-cover">
                <source src="/quadrotor.mp4" type="video/mp4" />
              </video>
              <div className="p-6 md:p-7">
                <h3 className="text-xl md:text-2xl font-semibold text-[#183b6b] mb-4">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {["MATLAB", "CoppeliaSim", "RRT*", "CLF-CBF-QP", "Control Systems"].map((tag) => (
                    <span key={tag} className="bg-[#e5f1ff] text-[#355070] px-3 py-1 rounded-full text-sm">{tag}</span>
                  ))}
                </div>
                <a href="https://github.com/Posheyla/quadrotor-rrt-clf-cbf-control" target="_blank" className="text-[#355070] font-medium hover:text-blue-900 transition">
                  View project →
                </a>
              </div>
            </div>
            ...
            <div className="bg-[#f7fbff] border border-[#dbe7f5] rounded-3xl overflow-hidden shadow-sm hover:shadow-2xl hover:-translate-y-2 transition duration-300">
              ...
              <div className="p-6 md:p-7">
                ...
                <p className="text-[#355070] leading-relaxed mb-6">
                  ...
                  delta robot integrated with computer vision and real-time material classification.
                </p>
                <div className="flex flex-wrap gap-2 mb-6">
                  {["Python", "CNN", "Computer Vision", "CoppeliaSim", "ABB IRB360"].map((tag) => (
                    <span key={tag} className="bg-[#e5f1ff] text-[#355070] px-3 py-1 rounded-full text-sm">{tag}</span>
                  ))}
                </div>
                <a href="https://github.com/Posheyla/waste-sorting-system-ROS-Coppelia" target="_blank" className="text-[#355070] font-medium hover:text-blue-900 transition">
                  View project →
                </a>
              </div>
            </div>
            ...
            {/* PROJECT 3 */}
            <div className="bg-[#f7fbff] border border-[#dbe7f5] rounded-3xl overflow-hidden shadow-sm hover:shadow-2xl hover:-translate-y-2 transition duration-300">
              <img src="/wearable.png" alt="SenseAhead Smart Shirt Poster" className="w-full h-56 md:h-64 object-contain bg-white"/>
              <div className="p-6 md:p-7">
                <h3 className="text-xl md:text-2xl font-semibold text-[#183b6b] mb-4">
                ...
                <p className="text-[#355070] leading-relaxed mb-6">
                  ...
                  SpO2, temperature, and IMU sensors with real-time visualization and motion segmentation.
                </p>
                <div className="flex flex-wrap gap-2 mb-6">
                  {["Arduino", "Sensors", "Wearables", "Signal Processing", "IoT"].map((tag) => (
                    <span key={tag} className="bg-[#e5f1ff] text-[#355070] px-3 py-1 rounded-full text-sm">{tag}</span>
                  ))}
                </div>
                <a href="https://github.com/Posheyla/SenseAhead--Smart-T-shirt-for-Vital-Sign-Monitoring" target="_blank" className="text-[#355070] font-medium hover:text-blue-900 transition">
                  View project →
                </a>
              </div>
            </div>
            ...
            {/* PROJECT 4 */}
            <div className="bg-[#f7fbff] border border-[#dbe7f5] rounded-3xl overflow-hidden shadow-sm hover:shadow-2xl hover:-translate-y-2 transition duration-300">
              <img src="/quantum.png" alt="Quantum Computing Project" className="w-full h-56 md:h-64 object-cover"/>
              <div className="p-6 md:p-7">
                <h3 className="text-xl md:text-2xl font-semibold text-[#183b6b] mb-4">
                ...
                <p className="text-[#355070] leading-relaxed mb-6">
                  ...
                  Hamiltonian simulation and analyzed approximation accuracy and complexity scaling.
                </p>
                <div className="flex flex-wrap gap-2 mb-6">
                  {["Python", "Qiskit", "Quantum Computing", "Optimization"].map((tag) => (
                    <span key={tag} className="bg-[#e5f1ff] text-[#355070] px-3 py-1 rounded-full text-sm">{tag}</span>
                  ))}
                </div>
                <a href="https://github.com/Posheyla/generalized-qsp-hamiltonian-simulation/tree/main" target="_blank" className="text-[#355070] font-medium hover:text-blue-900 transition">
                  View project →
                </a>
              </div>
            </div>
      ...
      <footer
        ...
        style={{ backgroundImage: "url('/footer-mountains.jpg')" }}
      >
        ...
        <div className="relative z-10 max-w-6xl mx-auto flex flex-col md:flex-row md:justify-between md:items-center gap-12">
          ...
          <div className="md:max-w-md">
            <p className="text-2xl font-[family-name:var(--font-playfair)] leading-snug">
              ...
              <br />safe, and meaningful
              <br />systems.
            </p>
          </div>

          <div className="space-y-4 text-[#355070] md:min-w-[320px]">
            <a href="mailto:lpchavez@ncsu.edu" className="flex items-center gap-3 hover:text-[#183b6b] transition">
              <Mail size={18} />
            ...
            <p className="text-sm text-[#7d93b2] mt-4 italic">
              Photography by{" "}
              <a href="https://www.instagram.com/jaychaisuksiri/" target="_blank" className="hover:text-[#355070] transition">
                @jaychaisuksiri
              </a>
            </p>
          </div>
